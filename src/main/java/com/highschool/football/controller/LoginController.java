...
public class LoginController {
    ...
    * */
    ...
    private CommonReponse<String> loginWithCode(@PathVariable String code, @RequestParam("avatar") String avatar, @RequestParam("nickName") String nickName){
        ...
        CommonReponse<String> response = new CommonReponse<>(CommonReponse.SUCCESS_CODE, CommonReponse.SUCCESS_MSG, sessionId);
        return response;
    }
    ...
    * 登录 session
    * */
    @GetMapping(value="/s/{sessionKey}")
    private void loginWithSession(@PathVariable String sessionKey){
